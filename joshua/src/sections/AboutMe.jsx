...
const AboutMe = () => {
  return (
    <AboutMeWrapper>
      <h2>About Me</h2>
      <p1>Hello, Im Joshua R. Bradshaw, a 34-year-old coding enthusiast based in San Antonio. Recently, I successfully completed the coding program at the University of Texas, where I honed my skills and developed a strong foundation in various technologies.
